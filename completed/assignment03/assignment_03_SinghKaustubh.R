...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point(aes(colors = sex))
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point(aes(colors = sex)) + ggtitle('Height vs. Earnings') + xlab('Height (Inches)') + ylab('Earnings (Dollars)')
