...
#installing package readxl, DBI, RSQLite
...
## Newer version of R dafaults stringsAsFactors = False. Set it to TRUE to match end result.
...
## Newer version of R dafaults stringsAsFactors = False.
